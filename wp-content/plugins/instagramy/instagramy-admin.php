...
<div class="wrap">	
	...
	<h2><?php _e( 'Instagram App info' , 'tieinsta' ) ?></h2>
	<br />
	<form method="post">
		<div id="poststuff">
...
<div class="wrap">	
	<div id="icon-options-general" class="icon32"><br></div>
	<h2><?php echo INSTAGRAMY_PLUGIN .' '.__( 'Settings' , 'tieinsta' ) ?></h2>
	<br />
	<form method="post">
		<div id="poststuff">
			<div id="post-body" class="columns-2">
...
class tie_instagram_widget extends WP_Widget {
	...
	function tie_instagram_widget() {
		...
		$this->WP_Widget( 'tie_insta-widget',  INSTAGRAMY_PLUGIN.' '. __( 'User Feed' , 'tieinsta' ) , $widget_ops, $control_ops );
	}
	...
	<div>
		<h4 class="tieinsta-widget-title"><?php _e( '- Account Info settings -' , 'tieinsta' ) ?></h4>
...
function tie_insta_shortcode( $atts, $content = null ) {
	$name = $style = $logo = $window = $nofollow = $credit = $info = $info_pos = $info_layout = $full_name = $website = $bio = $stats = $shape = $size = $media = $link = $layout = $columns = $speed = $effect = $com_like ='';
